...
const COMPONENT_SELECTOR = '.lux-modal__trigger';
...
class Modal extends Component {
  ...
  constructor (elem, config) {
    ...
    if (this._config.animated){
      Util.addClass(this._modalElem, lux.classes.ANIMATED);
      if (this._backdrop) {
    ...
    if (!this._shown) {
      ...
      if (this._config.animated){
        this._currentThreeStepsAnimation = Util.threeStepsAnimation(
          function () {
            Util.addClass(self._modalElem, lux.classes.TRANSITIONING);
            if (self._backdrop) {
              Util.addClass(self._backdrop, lux.classes.TRANSITIONING);
            }
          },
          function(){
            Util.addClass(self._modalElem, lux.classes.ACTIVE);
          ...
          function() {
            Util.removeClass(self._modalElem, lux.classes.TRANSITIONING);
            if (self._backdrop) {
        ...
        Util.addClass(self._modalElem, lux.classes.ACTIVE);
        Util.addClass(self._elem, lux.classes.ACTIVE);
        if (self._backdrop) { Util.removeClass(self._backdrop, lux.classes.CLOSED); }
        self._transitioning = false;
        self._shown = true;
        self._modalElem.dispatchEvent(
          Util.createEvent(EVENTS.show)
    ...
    if (this._shown) {
      ...
      if (this._config.animated){
        this._currentThreeStepsAnimation = Util.threeStepsAnimation(
          ...
          function(){
            Util.removeClass(self._modalElem, lux.classes.ACTIVE);
        ...
        Util.removeClass(self._modalElem, lux.classes.ACTIVE);
        Util.removeClass(self._elem, lux.classes.ACTIVE);
        if (self._backdrop) { Util.addClass(self._backdrop, lux.classes.CLOSED); }
        self._transitioning = false;
        self._shown = false;
        self._modalElem.dispatchEvent(
          Util.createEvent(EVENTS.hide)
