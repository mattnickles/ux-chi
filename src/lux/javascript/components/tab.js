...
const COMPONENT_SELECTOR = '.lux-tabs';
const COMPONENT_TYPE = "tab";
const SUBTAB_SELECTORS = 'ul.lux-tabs__subtabs';
const TABS_PANEL_CLASS = "lux-tabs-panel";
...
class Tab extends Component {
  ...
  isVertical () {
    ...
    let isVertical = Util.hasClass(this._elem, CLASS_VERTICAL) ||
      ...
      Util.getMediaWidth() < lux.responsiveBreakpoints.md
    ;
