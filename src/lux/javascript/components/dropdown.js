...
const CLASS_DROPDOWN = 'lux-dropdown__menu';
const CLASS_DROPDOWN_ITEM = 'lux-dropdown__menu-item';
const CLASS_MOLECULE = "lux-dropdown";
const CLASS_COMPONENT = 'lux-dropdown__trigger';
const COMPONENT_SELECTOR = '.lux-dropdown__trigger';
