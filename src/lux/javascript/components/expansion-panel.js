...
const CLASS_COLLAPSE_WRAPPER = 'lux-epanel__collapse';
const COMPONENT_SELECTOR = '.-lux-epanel';
...
const EPANEL_EVENT_CHANGE = 'lux.epanel.change';
...
class ExpansionPanel extends Component {
  ...
  _initGroup () {
    const groupName = this._elem.dataset.luxEpanelGroup;
    if (!groupName) {
      return;
    }
  ...
  _findEpanelAction (elem) {
    if (elem.dataset && elem.dataset.luxEpanelAction) {
      return elem.dataset.luxEpanelAction;
    } else if (
      elem.parentNode &&
