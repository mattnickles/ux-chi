...
describe('Number input', function() {
  ...
  describe('Number input base', function() {
    ...
    it('Number input custom element should initiate a Lux number-input component. ', function() {

      checkComponent('@base_number_input', 'lux-number-input');
    });
  ...
  describe('Number input expanded', function() {
    ...
    it('Number input custom element should initiate an expanded Lux number-input component. ', function() {

      checkComponent('@expanded_number_input', 'lux-number-input');
    });
