...
describe('Expansion panel', function() {
    ...
    it('Expansion panel custom element should initiate a Lux expansion-panel component. ', function() {

        cy.get('[data-cy="test-done"]')
            .should('have.class', 'hydrated')
            .children()
            .first()
            .should('have.class', 'lux-epanel');
    });
