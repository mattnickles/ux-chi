describe('Spinner', () => {
  ...
  it('Colored spinner should have appropriate class', () => {
    assertion('@spinner-secondary', 'svg.lux-spinner.-icon--secondary');
  });

  it('Sized spinner should have appropriate class', () => {
    assertion('@spinner-xxl', 'svg.lux-spinner.-xxl');
  });
});
