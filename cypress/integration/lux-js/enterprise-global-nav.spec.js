import { SIDENAV_COMPONENT_SELECTOR } from '../../../src/lux/javascript/components/sidenav';
      ...
      cy.get(SIDENAV_COMPONENT_SELECTOR).within(() => {
        ...
        cy.get('@firstLevelElement')
          ...
          .then(href => {
            ...
            cy.get(href + ' .lux-sidenav__drawer-list li span.lux-sidenav__title')
              .contains(/^Home$/)
              .click()
              .parents('li')
  ...
  describe('Check that Menu recovers active state of second and third level items', () => {
    it('Should recover active state when toggling between different lists on 2nd level', () => {
      ...
      cy.get('@drawer')
        ...
        .parents('li')
        .should('have.class', '-expanded')
        .find('.lux-sidenav__drawer-item-list ul li a span')
        .contains('Reports')
        .click()
        .parents('a')
        .should('have.class', '-active')
      ...
      cy.get('@drawer')
        .find('ul.lux-sidenav__drawer-list li a span')
        .contains('Home')
        .parents('a')
        .parents('li')
        .should('have.class', '-active')
